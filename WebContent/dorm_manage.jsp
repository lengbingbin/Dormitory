	...
	<div id="win" class="easyui-window" title="宿舍信息编辑" style="width:500px;height:300px"   
	    ...
	    <form id="editForm" method="post">
	    	...
	    	<input type="hidden" name="id">
		  	宿舍号&nbsp&nbsp&nbsp：<input type="text" name="d_id" class="easyui-validatebox" data-options="required:true"/><br/>
		  	总床位&nbsp&nbsp&nbsp：<input type="text" name="total" class="easyui-validatebox" data-options="required:true"/><br/>
		  	已用床位：<input type="text" name="used" class="easyui-validatebox" data-options="required:true"/><br/>
		  	宿舍长&nbsp&nbsp&nbsp：<input type="text" name="dormadmin" class="easyui-validatebox" data-options="required:true"/><br/>
  	...
  	<script type="text/javascript">
  		$(function(){
  			...
  			$("#editBtn").click(function(){
  				...
  				//表单回显
  				$("#editForm").form("load","dormitory/findById.action?id="+rows[0].id);
  			...
  			$("#deleteBtn").click(function(){
  				...
  				$.messager.confirm("提示","确认删除数据吗?",function(value){
  					if(value){
						...
						alert(idStr);
  						//传递到后台
  						$.post("dormitory/delete.action",idStr,function(data){
  							if(data.success){
  	  							//刷新datagrid
  	  							$("#list").datagrid("reload");
