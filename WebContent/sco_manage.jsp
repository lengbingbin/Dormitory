	...
	<div id="win" class="easyui-window" title="损耗数据编辑" style="width:500px;height:300px"   
	    ...
	    <form id="editForm" method="post">
	    	...
	    	<input type="hidden" name="id">
		  	宿舍评分：<input type="text" name="score" class="easyui-validatebox" data-options="required:true"/><br/>
		  	宿舍号&nbsp&nbsp&nbsp：<input type="text" name="dormid" class="easyui-validatebox" data-options="required:true"/><br/>
  	...
  	<script type="text/javascript">
  		$(function(){
  			...
  			$("#editBtn").click(function(){
  				...
  				//表单回显
  				$("#editForm").form("load","dormitory/scofindById.action?id="+rows[0].id);
  			...
  			$("#deleteBtn").click(function(){
  				...
  				$.messager.confirm("提示","确认删除数据吗?",function(value){
  					if(value){
  						...
  						//传递到后台
  						$.post("dormitory/scodelete.action",idStr,function(data){
  							if(data.success){
  	  							//刷新datagrid
  	  							$("#list").datagrid("reload");
