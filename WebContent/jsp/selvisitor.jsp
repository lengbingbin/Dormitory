...
<div style="background:#c0c0c0; color:#000;height:40px">
	        ...
	        <a href="../DormServlet?opt=adm" style="width:75px; margin-left:160px;color:white;Font-size:28px">宿舍信息</a>
            <a href="../DamServlet?opt=adm" style="width:75px; margin-left:160px;color:white;Font-size:28px">商品保修</a>
            <a href="../VisitorServlet" style="width:75px; margin-left:160px;color:white;Font-size:28px">访客信息</a>
            <a href="../SorceServlet" style="width:75px; margin-left:160px;color:white;Font-size:28px">宿舍评分</a>
            <a href="../StuinfoServlet" style="width:75px; margin-left:160px;color:white;Font-size:28px">学生信息</a>
</div>
<div align="center" style ="border:10px solid #c0c0c0;margin-top:60px;background-color:#ffffff;margin-left:250px;margin-right:250px">
 <form action="../SelServlet" method="post">
	...
	<thead>
	  ...
	  <tbody>
              <c:forEach items="${svislist}" var="svislist">
                  <tr>
                       <td>${svislist.visitorname}</td>
                       <td>${svislist.studentid}</td>
                       <td>${svislist.starttime}</td>
                       <td>${svislist.endtime}</td>
                       <td>
                       <a href="../DamDelServlet?op=deleteVis&id=${svislist.id}">删除</a>
                       </td>
                   </tr>
               </c:forEach>
       </tbody>
