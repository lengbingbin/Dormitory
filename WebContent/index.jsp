    ...
    <div data-options="region:'west',title:'系统菜单',split:true" style="width:200px;">
    	<div id="aa" class="easyui-accordion" style="width:193px;" data-options="border:0,multiple:true" >   
		    <div title="系统管理" data-options="iconCls:'icon-save'" style="overflow:auto;padding:10px;">   
		       <ul>
		       	 <li><a href="javascript:void(0)" pageUrl="user_manage.jsp">宿管管理</a></li>
		       </ul>
		    </div>   
		    <div title="宿舍信息管理" data-options="iconCls:'icon-reload',selected:true" style="padding:10px;">   
		       <ul>
		       	 <li><a href="javascript:void(0)" pageUrl="dorm_manage.jsp">宿舍信息</a></li>
		       	 <li><a href="javascript:void(0)" pageUrl="vis_manage.jsp">访客信息</a></li>
		       	 <li><a href="javascript:void(0)" pageUrl="dam_manage.jsp">损耗物品</a></li>
		       	 <li><a href="javascript:void(0)" pageUrl="sco_manage.jsp">宿舍评分</a></li>
		       </ul>
		    </div>     
		</div>  
    </div>   
