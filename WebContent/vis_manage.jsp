	...
	<div id="win" class="easyui-window" title="宿舍信息编辑" style="width:500px;height:300px"   
	    ...
	    <form id="editForm" method="post">
	    	...
	    	<input type="hidden" name="id">
		  	访客姓名：<input type="text" name="visitorname" class="easyui-validatebox" data-options="required:true"/><br/>
		  	访问学生号：<input type="text" name="studentid" class="easyui-validatebox" data-options="required:true"/><br/>
		  	进入时间：<input type="text" name="starttime" class="easyui-validatebox" data-options="required:true"/><br/>
		  	离开时间：<input type="text" name="endtime" class="easyui-validatebox" data-options="required:true"/><br/>
  	...
  	<script type="text/javascript">
  		$(function(){
  			...
  			$("#editBtn").click(function(){
  				...
  				//表单回显
  				$("#editForm").form("load","dormitory/visfindById.action?id="+rows[0].id);
  			...
  			$("#deleteBtn").click(function(){
  				...
  				$.messager.confirm("提示","确认删除数据吗?",function(value){
  					if(value){
						...
						alert(idStr);
  						//传递到后台
  						$.post("dormitory/visdelete.action",idStr,function(data){
  							if(data.success){
  	  							//刷新datagrid
  	  							$("#list").datagrid("reload");
